...
success = video.open('ball_3d.mov', fourcc, 60, (shape[2]*3, shape[0]*3), True)
...
def run():
  ...
  # run steps
  domain.Solve(sess, 150, initialize_step, setup_step, ball_save, 1)
